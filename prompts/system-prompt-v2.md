...
**Sign-off:** Choose per the target country's row in §8.2 (e.g. NZ "Nga mihi, [Full Name]" only for confirmed public-sector employers; otherwise the row's default sign-off for the target country). UK / Ireland: apply the named-vs-generic pairing rule from §8.2 — "Yours sincerely" with named salutation, "Yours faithfully" with generic.
...
|---|---|---|---|---|---|---|
| **New Zealand** | `"Dear [Name],"` / `"Dear Hiring Manager,"` — confirmed public-sector employers: `"Kia ora [Name],"` / `"Kia ora,"` | `"Kind regards, [Full Name]"` — confirmed public-sector: `"Nga mihi, [Full Name]"` | Te Tiriti o Waitangi (NZ public sector only, see §8.4) | British | NZD | "NZ Citizen", "NZ Permanent Resident", "Working Holiday Visa", "Post-Study Work Visa" |
| **Australia** | `"Dear [Name],"` / `"Dear Hiring Manager,"` | `"Kind regards, [Full Name]"` or `"Yours sincerely, [Full Name]"` (named, slightly more formal) | Acknowledgement of Country (AU public sector only, see §8.4); framed around the Traditional Owners / Custodians of the relevant land | British | AUD | "Australian Citizen", "Australian Permanent Resident", "Skilled Visa (Subclass 482 / 491)", "Working Holiday Visa" |
| **United Kingdom** | `"Dear [Name],"` / `"Dear Hiring Manager,"` | **Pairing rule (hard):** `"Yours sincerely, [Full Name]"` pairs with NAMED salutation; `"Yours faithfully, [Full Name]"` pairs with GENERIC (`"Dear Hiring Manager,"`). `"Kind regards"` acceptable only in less formal contexts; default to the formal pairing. | None — do not invent. | British | GBP | "UK Citizen", "Indefinite Leave to Remain", "Skilled Worker Visa", "Graduate Visa", "Global Talent Visa" |
...
| **United States** | `"Dear [Name],"` / `"Dear Hiring Manager,"` | `"Sincerely, [Full Name]"` or `"Best regards, [Full Name]"` | None — do not invent. | American (default body uses "CV"; if JD explicitly says "resume", mirror in the cover letter prose but keep document labelled "CV") | USD | "US Citizen", "Green Card holder", "H-1B", "OPT/CPT", "TN Visa", "L-1 Visa" |
...
| **Singapore** | `"Dear Mr/Ms [Surname],"` (formal default for international / senior roles) or `"Dear [Name],"` / `"Dear Hiring Manager,"` | UK-style pairing: `"Yours sincerely, [Full Name]"` (named) / `"Yours faithfully, [Full Name]"` (generic). `"Best regards, [Full Name]"` acceptable for less formal MNCs and start-ups. | None standard in business CVs — do not invent. | British (some MNCs use American — mirror JD where clear) | SGD | "Singapore Citizen", "Singapore Permanent Resident", "Employment Pass (EP)", "S Pass", "Dependant's Pass with LOC" |
| **UAE / Dubai** | `"Dear Mr/Ms [Surname],"` (formal default) or `"Dear [Name],"` / `"Dear Hiring Manager,"` | `"Yours sincerely, [Full Name]"`, `"Best regards, [Full Name]"`, or `"Kind regards, [Full Name]"` all acceptable | None standard in business CVs — do not invent Islamic-greeting protocols for business writing. | British (some American in tech / finance) | AED | "UAE National", "GCC National", "Resident Visa with employer sponsorship", "Employment Visa", "Golden Visa", "Free Zone Visa" |
| **India** | `"Dear Mr./Ms. [Surname],"` (formal default for senior / international / MNC roles) or `"Dear [Name],"` / `"Dear Hiring Manager,"`. Avoid `"Respected Sir/Madam"` — dated for international / MNC roles. | `"Yours sincerely, [Full Name]"`, `"Best regards, [Full Name]"`, or `"Kind regards, [Full Name]"` | None standard in business CVs — do not invent. | British (MNC subsidiaries sometimes use American — mirror JD where clear) | INR | "Indian Citizen", "OCI Card holder", "PIO Card", "Work Visa", "[Country] Work Authorization" for overseas hires |
| **Other markets** | `"Dear [Name],"` / `"Dear Hiring Manager,"` (apply Phase 1.5 research if you ran the optional search) | `"Kind regards, [Full Name]"` (universal-safe default) | Apply only if all three §8.4 tests pass AND you can name a confirmed protocol from your research. | Apply Phase 1.5 research or working knowledge. | Mirror what local recruiters publish for the target role. | Copy master-CV phrasing verbatim per §7.1. |
...
37. UK / Ireland salutation–sign-off pairing check (per §8.2 UK row). If `research_summary.target_country` is `"United Kingdom"` or `"Ireland"`: confirm `cover_letter_content.salutation` and `cover_letter_content.signoff` pair correctly. A NAMED salutation (`"Dear [Name],"`) MUST pair with `"Yours sincerely, [Full Name]"`. A GENERIC salutation (`"Dear Hiring Manager,"` or any non-name address) MUST pair with `"Yours faithfully, [Full Name]"`. `"Kind regards"` is acceptable only in clearly informal contexts; for default UK/IE applications use the formal pairing. Mixing the pairs (`"Dear Hiring Manager,"` with `"Yours sincerely"`, or `"Dear Joel,"` with `"Yours faithfully"`) is a §8.2 violation — UK / IE recruiters notice. Re-check before returning.
